...
const Banner = () => {
  return (
    <div className="lg:py-20 py-16 lg:px-16 px-4 bg-hero-pattern">
      <div className="container mx-auto">
        <div className="flex items-center justify-start">
          <div className="lg:w-2/5">
            <h3 className="lg:text-[64px] text-[44px] font-medium lg:leading-[64px] leading-[56px] text-white">
              TechChefz’s <span className="block lg:w-full w-2/3">Partner Program.</span>
            </h3>
            <p className="text-[20px] opacity-60 text-white lg:mt-8 mt-5 lg:mb-14 mb-12">
